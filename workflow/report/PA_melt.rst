Table of the mapping of the protein in the genomes. Each line correspond to an information. The format is : genome_id, genome_name, seed, PA, color, protein_id.
